...
1. 下载 [`apk/AnySearch-v1.2.1.apk`](https://github.com/paomianyaoren/anysearch-downloader/blob/main/AS_Tool%201.2.1/apk/AnySearch-v1.2.1.apk)（或到 GitHub Releases 下载同名文件）传到手机；
